  ...
  return (
    <section className="relative bg-secondary">
      <div
        ...
        style={{
          background:
            "radial-gradient(600px circle at 10% 20%, color-mix(in oklab, var(--primary) 18%, transparent), transparent 40%), radial-gradient(500px circle at 85% 25%, color-mix(in oklab, var(--primary) 14%, var(--muted)), transparent 45%), radial-gradient(700px circle at 50% 90%, color-mix(in oklab, var(--accent, var(--primary)) 12%, transparent), transparent 50%)",
      ...
      <div className=" mx-auto px-6 py-20 md:py-24">
        <header className="container mb-12 flex flex-col gap-3">
          <h2 className="text-balance text-4xl md:text-5xl font-bold tracking-tight text-primary">
            Voices of Nexverse: Student Testimonials
          </h2>
          <p className="text-pretty text-muted-foreground md:text-lg">
            Real stories from our community—how Nexverse events, projects, and mentorship help students grow faster,
            build stronger portfolios, and lead with confidence.
          </p>
        </header>
